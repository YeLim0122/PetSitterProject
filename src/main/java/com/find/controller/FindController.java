...
public class FindController {
	...
	public String insertHeart(@RequestParam int ino, HttpSession session, Model m) {
		...
		fService.insertHeart(wish);
		
		return "redirect:/shop/info";
	}
	
	@GetMapping("/deleteHeart")
	public String deleteHeart(@RequestParam(defaultValue="0")int num, HttpServletRequest req) {
